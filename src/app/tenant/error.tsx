...
export default function TenantError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="bg-white border border-slate-200/80 p-8 rounded-3xl max-w-md shadow-premium-sm text-center flex flex-col items-center gap-5 mx-auto mt-12">
      ...
      <div>
        <h2 className="text-lg font-extrabold text-slate-900 tracking-tight">Resident Dashboard error</h2>
        <p className="text-xs text-slate-500 mt-1 max-w-xs leading-relaxed font-semibold">
          Could not fetch stay, rent billing, or maintenance logs for your tenant profile.
        </p>
      </div>
