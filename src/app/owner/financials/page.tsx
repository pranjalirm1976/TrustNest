...
export const metadata: Metadata = {
  title: 'Financial Management | TrustNest Owner',
  description: 'Track and manage rent payments, collection rates, and financial transactions.',
}
  ...
  return (
    <div className="w-full flex flex-col h-[calc(100vh-140px)] min-h-[600px]">
      <div className="mb-6 shrink-0">
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Financial Management</h1>
        <p className="text-sm text-slate-500 mt-1">Financial control center to track expected vs. collected rent across your property.</p>
      </div>
