...
async function requireSuperAdmin() {
  ...
  if (session && session.user?.role && session.user.role !== 'SUPER_ADMIN' && session.user.role !== 'INSPECTOR') {
  ...
  try {
    ...
    return {
      ...
      financials: {
        ...
        residentRentGrossVolume: totalResidentRentVolume,
      },
      complaints: {
